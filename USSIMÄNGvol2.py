...
#Toit
raadius = 10
x1 = randint(border+raadius, laius-border*2-raadius)
y1 = randint(border+raadius, kõrgus-border*2-raadius)
...
while tõeväärtus:
    ...
    if dist <= 12:
        x1 = randint(border+raadius, laius-border-raadius)
        y1 = randint(border+raadius, kõrgus-border-raadius)
